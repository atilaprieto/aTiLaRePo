...
class Deportes:
    def __init__(self):
        competiciones_soccer=[
            ...
            Competition('Primeira Liga',['PORTUGAL LEAGUE','PORTUGAL SUPERLIGA', 'Portugal - Primeira Liga','PORTUGAL A LIGA','PORTUGAL A LEAGUE','PORTUGAL A-LIGA'],os.path.join(image_path, 'soccer_liga_portugal.png')),
            ...
            Competition('Copa Italia',['ITALY CUP','Italy - Coppa Italia'],os.path.join(image_path, 'soccer_italy_cup.png')),
            Competition('A-League',['Australia - A-League','AUSTRALIA A-LEAGUE','A-LEAGUE'],os.path.join(image_path, 'soccer_liga_australiana.png')),
            ...
            Competition('Copa Mundial de Clubes de la FIFA',['FIFA Club World Cup','FIFA WORLD CUP CLUB'],os.path.join(image_path, 'fifa_club.png')),
