######################################################################################################################################################
##
## Merlin Auto Cleaner - Extracted From Aftermath Wizard With Edits By Myself!
##
######################################################################################################################################################
			...
			for root, dirs, files in os.walk(PACKAGES):
				...
				if file_count > 0:
					...
					if yes:
						...
						LogNotify(ADDONTITLE,'[COLOR yellow]Packages Purged:[/COLOR] [COLOR red]Success[/COLOR]!')
