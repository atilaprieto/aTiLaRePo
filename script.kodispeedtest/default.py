...
def i1Ii1i1I11Iii ( list = False , mini = None , server = None , share = False , simple = False , src = None , timeout = 10 , units = ( 'bit' , 8 ) , version = False ) :
 ...
 OoO0O00O0oo0O = [ ' ' , ' ' , ' ' ]
 I1i1i1 . create ( Iii1ii1II11i + ' - [COLOR lime]Catoal[/COLOR]' , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 ...
 OoO0O00O0oo0O [ 0 ] = 'Recuperando la configuracion de speedtest.net ...'
 I1i1i1 . update ( 10 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 if not simple :
  Ii11iI1i ( 'Recuperando la configuracion de speedtest.net ...' )
 try :
  OOoO = O0oO ( )
 except URLError :
  I1i1i1 . close ( )
  Ii11iI1i ( 'No se puede recuperar la configuracion de speedtest' )
  sys . exit ( 1 )
  if 44 - 44: II111iiii
 OoO0O00O0oo0O [ 1 ] = 'Recuperando la lista de servidores de speedtest.net ...'
 I1i1i1 . update ( 15 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 if not simple :
  Ii11iI1i ( 'Recuperando la lista de servidores de speedtest.net ...' )
 if list or server :
 ...
 OoO0O00O0oo0O [ 2 ] = 'Tu servicio %(isp)s (%(ip)s)' % OOoO [ 'client' ]
 I1i1i1 . update ( 25 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 if not simple :
  Ii11iI1i ( 'Tu servicio %(isp)s (%(ip)s)' % OOoO [ 'client' ] )
  if 44 - 44: o0OO0
 if server :
  try :
 ...
 OoO0O00O0oo0O [ 0 ] = OoO0O00O0oo0O [ 1 ]
 OoO0O00O0oo0O [ 1 ] = OoO0O00O0oo0O [ 2 ]
 OoO0O00O0oo0O [ 2 ] = 'Calculando velocidad de bajada...'
 I1i1i1 . update ( 50 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 if not simple :
  Ii11iI1i ( 'Velocidad de bajada' , end = '' )
 Oo00o0OO0O00o = i1iI11i1ii11 ( iI1111iiii , simple )
 if not simple :
  Ii11iI1i ( )
 OoO0O00O0oo0O [ 0 ] = OoO0O00O0oo0O [ 1 ]
 OoO0O00O0oo0O [ 1 ] = OoO0O00O0oo0O [ 2 ]
 OoO0O00O0oo0O [ 2 ] = 'Bajada: [COLOR red]%0.2f[/COLOR] M%s/s' % ( ( Oo00o0OO0O00o / 1000 / 1000 ) * units [ 1 ] , units [ 0 ] )
 I1i1i1 . update ( 70 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 Ii11iI1i ( 'Bajada: %0.2f M%s/s' %
 ...
 OoO0O00O0oo0O [ 0 ] = OoO0O00O0oo0O [ 1 ]
 OoO0O00O0oo0O [ 1 ] = OoO0O00O0oo0O [ 2 ]
 OoO0O00O0oo0O [ 2 ] = 'Calculando velocidad de subida...'
 I1i1i1 . update ( 80 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 if not simple :
  Ii11iI1i ( 'Velocidad de subida' , end = '' )
 O0OOoOOO0oO = oO0OOOO0 ( OOoooO00o0oo0 [ 'url' ] , oOoO0 , simple )
 if not simple :
  Ii11iI1i ( )
 OoO0O00O0oo0O [ 0 ] = OoO0O00O0oo0O [ 1 ]
 OoO0O00O0oo0O [ 1 ] = OoO0O00O0oo0O [ 2 ]
 OoO0O00O0oo0O [ 2 ] = 'Subida: [COLOR yellow]%0.2f[/COLOR] M%s/s' % ( ( O0OOoOOO0oO / 1000 / 1000 ) * units [ 1 ] , units [ 0 ] )
 I1i1i1 . update ( 99 , OoO0O00O0oo0O [ 0 ] , OoO0O00O0oo0O [ 1 ] , OoO0O00O0oo0O [ 2 ] )
 Ii11iI1i ( 'Subida: %0.2f M%s/s' %
...
class O0iIiIIIIIii ( xbmcgui . WindowDialog ) :
 def __init__ ( self ) :
  ...
  self . button0 = xbmcgui . ControlButton ( int ( 340 + 505 ) , int ( 210 + 206 ) , 80 , 50 , "[B]Cerrar[/B]" )
 ...
 def saveClose ( self ) :
  OOo = xbmcgui . Dialog ( )
  i1i11I1I1iii1 = OOo . yesno ( "Salvar resultados" , "Te gustaria guardar una copia de esta prueba de velocidad" , "" , "" )
  if i1i11I1I1iii1 :
   self . location = OOo . browse ( 3 , 'Donde te gustaria guardar el resultado' , 'files' , '' , False , False , '' )
   print 'self.location'
   print self . location
   import urllib
   ...
   OOo . ok ( "Resultado Salvado!" , "'%s.png'" % oo00o0Oo0oo + " Fue guardado en '" + self . location + "'" )
  OOo . ok ( "Resultado Salvado!" , "Test finalizado!" )
  self . close ( )
  if 74 - 74: O0 / i1IIi
...
class ii1O0 ( xbmcgui . WindowDialog ) :
 ...
 def saveClose ( self ) :
  ...
  if 45 - 45: ooO00oOoo
  OOo = xbmcgui . Dialog ( )
  i1i11I1I1iii1 = OOo . yesno ( "Salvar resultado" , "Te gustaria guardar una copia de esta prueba de velocidad" , "" , "" )
  if i1i11I1I1iii1 :
   self . location = OOo . browse ( 3 , 'Donde te gustaria guardar el resultado' , 'files' , '' , False , False , '' )
   print 'self.location'
   print self . location
   ...
   OOo . ok ( "Resultado Salvado!" , "'4670696458.png'" + " Fue guardado en '" + self . location + "'" )
  OOo . ok ( "Resultado Salvado!" ,  )
  self . close ( )
