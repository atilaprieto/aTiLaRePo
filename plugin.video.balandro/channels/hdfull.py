...
def do_downloadpage(url, post=None):
    ...
    data = httptools.downloadpage(url, post=post, headers={'Referer': 'https://hdfull.io', 'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/79.0.3945.130 Chrome/79.0.3945.130 Safari/537.36'}).data
